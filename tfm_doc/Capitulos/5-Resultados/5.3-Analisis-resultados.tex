...
\begin{itemize}
    ...
    \item \textbf{Eficiencia computacional}: Las SNN presentan potencial para aplicaciones de tiempo real debido a la \textit{sparsity} inherente de los impulsos discretos, con ventajas teóricas en eficiencia energética que requieren validación en hardware neuromórfico.
